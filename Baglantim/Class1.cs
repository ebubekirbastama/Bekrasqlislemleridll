...
namespace Baglantim
{
    public class Class1
    {
        ...
        {
           //
            System.Data.SqlClient.SqlConnection con = new System.Data.SqlClient.SqlConnection(@"Server=DESKTOP-24DHSD5\SQLEXPRESS; Integrated Security=true; Database=kutuphane");
